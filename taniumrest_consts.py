...
TANIUMREST_GET_SAVED_ACTION = "/api/v2/saved_actions/{saved_action_id}"
TANIUMREST_GET_ACTION = "/api/v2/actions/{action_id}"
TANIUMREST_GET_ACTION_RESULTS = "/api/v2/result_data/action/{action_id}"
TANIUMREST_ACTION_POLL_MAX_SECONDS = 300
...
TANIUMREST_DELETE_MANUAL_GROUP = "/api/v2/computer_groups/{group_id}"
